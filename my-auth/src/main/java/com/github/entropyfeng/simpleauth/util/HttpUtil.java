...
public class HttpUtil {
    ...
    public static String getToFind(HttpServletRequest request,String toFind){
        toFind= (String)request.getAttribute(toFind);

        if(StringUtils.isEmpty(toFind)){
            toFind=request.getParameter(toFind);
        }else {
            return toFind;
        }

        if(StringUtils.isEmpty(toFind)){
            toFind= (String) request.getSession().getAttribute(toFind);
        }
        return toFind;
    }
